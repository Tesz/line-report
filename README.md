...
I'm tired and frustrated having to save photos as files just to create reports. LINE is not a suitable platform for work discussions, but Thai people really love using this app.

So I had to find a way to create reports to record the daily work that my subordinates report, and save it in my Obsidian vault for reference later.

- I select concern msg/photo/videos ➔ send to Keep Memo ➔ Log in to PC later ➔ Download Chat log & images ➔ Generate report then clear Keep Memo
- This project was generated by AI based on [SPEC.md](https://github.com/Tesz/line-report/blob/main/SPEC.md)
- For more details on [how it works](https://github.com/Tesz/line-report/blob/main/how-it-works.md)
